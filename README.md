...
This project was completed as part of my SOC Analyst Internship. The objective was to build a Security Operations Center (SOC) lab environment using pfSense Firewall, Ubuntu SOC Server, Syslog-ng, and Wazuh SIEM to centralize firewall logs and monitor security events.
